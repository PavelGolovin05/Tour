    ...
    <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
            <div class="col-md-9 ftco-animate pb-5 mb-5 text-center">
                <h1 class="mb-3 bread">Наши туры</h1>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="search-wrap-1 ftco-animate p-4">
                    <form action="{{ url('tours/findTours/') }}" class="search-property-1">
                        <div class="row">
                            ...
                            <div class="col-lg align-items-end">
                                <div class="form-group">
                                    ...
                                    <div class="form-field">
                                        <input type="date"  name="date" style="border: none !important;">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg align-items-end">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="project">
                    <div class="img">
                        <img src="{{$tour->photo_link}}" class="img-fluid" alt="Colorlib Template">
                    </div>
                    <div class="text">
                        <h4 class="price">{{$tour->cost}}р.</h4>
                        <span>{{$tour->country}} {{$tour->city}}</span>
                        <h3><a href="{{ url('tours/tour?id=' . $tour->id . '&remove=0') }}">{{$tour->hotel}}</a></h3>
                    ...
                    <a href="{{$tour->photo_link}}" class="icon image-popup d-flex justify-content-center align-items-center">
